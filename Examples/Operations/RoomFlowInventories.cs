...
namespace Examples.Operations
{
  public class RoomFlowInventories : Base
  {
    ...
    /// </summary>  
    public RoomFlowInventoriesModel Add(string organizationCode, int eventID, string property, string roomType, string flowRecordType, decimal price, int forecasted, string useSameRates, string blockCode)
    {
